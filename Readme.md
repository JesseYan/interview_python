...
- static_foo 只有A类或者其实例才可以用。


foo vs class_foo:
- foo 实例调用
- class_foo：第一个参数时cls，类或者实例调用。实例（可看做先有类，在有实例，所以本质上也是有类）

static_foo vs class_foo
- static_foo：可以少传cls参数，减少类的开支。
...
墙裂推荐[知乎 python的GIL、多线程、多进程 ](https://zhuanlan.zhihu.com/p/20953544)
...
[强烈推荐参考](https://juejin.im/post/5c13245ee51d455fa5451f33)
py2 与 py3不同
...
[资料参考](https://www.liaoxuefeng.com/wiki/1022910821149312/1023021250770016)
